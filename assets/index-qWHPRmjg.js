  ...
  <main>
    <section class="page plan-page" data-page="plan">
      ...
      <div class="plan-grid">
        <article class="forecast-card">
          <div class="section-title"><div><span class="eyebrow">תחזית</span><h2>הגשר עד גיל הפרישה</h2></div><span class="outline-pill" id="cityBadge">כפר סבא</span></div>
    ...
    <section class="page check-page" data-page="check">
      <div class="page-heading compact">
        ...
        <div class="context-pill"><span id="checkCity">כפר סבא</span><b>•</b><span id="checkHorizon">10 שנים ליעד</span></div>
      </div>
      ...
      <form id="profileForm" class="profile-form">
        <fieldset>
          ...
          <div class="profile-grid">
            <label>עיר מגורים<input id="city" value="כפר סבא" placeholder="עיר מגורים"></label>
            <label>מבוגרים במשק הבית<select id="adults"><option>1</option><option selected>2</option><option>3</option></select></label>
            <label>הגיל שלך<input id="currentAge" type="number" min="18" max="90" value="41"></label>
            <label>גיל בן/בת הזוג<input id="partnerAge" type="number" min="18" max="90" value="42"></label>
            <label>ילדים או תלויים<select id="children"><option selected>0</option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option></select></label>
            <label>עצמאות כלכלית בעוד<input id="independenceYears" type="number" min="1" max="40" value="10"><small>שנים</small></label>
        ...
        <fieldset>
          ...
          <div class="profile-grid">
            ...
            <label>הוצאות חודשיות שוטפות<input id="monthlyExpenses" type="number" value="16000"></label>
            <label>עלות דיור מתוך ההוצאות<input id="housingCost" type="number" value="6500"></label>
            <label>הוצאות שנתיות נוספות<input id="annualIrregular" type="number" value="12000"></label>
            <label>הכנסה פסיבית חודשית<input id="passive" type="number" value="1200"></label>
            <label>רמת חיים רצויה בחופש<input id="targetSpend" type="number" value="12000"></label>
        ...
        <fieldset>
          ...
          <div class="profile-grid">
            <label>חסכונות והשקעות נזילים<input id="capital" type="number" value="580000"><small>ללא פנסיה</small></label>
            <label>כסף נזיל למקרי חירום<input id="emergency" type="number" value="55000"></label>
            <label>חיסכון פנסיוני כיום<input id="pensionCapital" type="number" value="650000"></label>
            <label>הפקדה חודשית לפנסיה<input id="pensionContribution" type="number" value="3500"></label>
            <label>קצבה חודשית צפויה בפרישה<input id="expectedPension" type="number" value="7000"></label>
            <label>קצבת אזרח ותיק צפויה<input id="oldAgeBenefit" type="number" value="2750"><small>הערכה בלבד</small></label>
            <label>יתרת משכנתה<input id="mortgageBalance" type="number" value="620000"></label>
